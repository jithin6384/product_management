class ProductsController < ApplicationController
    ...
    def create
      ...
      @product = Product.create(product_name: params["product"]["product_name"],product_descprition: params["product"]["product_description"],brand_name: params["product"]["brand_name"] )
       Product.write_csv
